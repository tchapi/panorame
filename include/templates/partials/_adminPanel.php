    <div id="admin" class="modal">
      ...
      <div class="form-inline modal-body">
        ...
        <p class="muted"><span class="lsf">info</span> <em>Mouse over an edge to make it editable.<br/>To delete an edge, right-click on it.<br/>Vertices will auto-merge under <?php echo _closestPointRadius_edit; ?>m.</em></p>
        <div class="form-line">
          <p><span class="lsf">keyboard</span> <strong>Keyboard shortcuts :</strong></p>
          <ul>
      ...
      <div class="modal-footer">
        <button id="addEdge" class="btn btn-info" ><span class="lsf">plus</span> Add edges (a)</button>
      </div>
    </div>